...
function ShopDetail() {
  const {id}=useParams()
    console.log("id d'un produit est ",id)
    ...
    const getByid=async()=>{
        try {
            ...
            if(res){
               ...
               console.log("les donne de notre produit sont ",res.data.data)
            ...
            console.log("impossible de chargé les donne",error)
  ...
  <div className="container-fluid py-5">
    <div className="row px-xl-5">
      ...
      <Slider img={produit?.galleries} /> 
      </div>
      <div className="col-lg-7 pb-5">
        <h3 className="font-weight-semi-bold">{produit?.ref}</h3>
        ...
        <h3 className="font-weight-semi-bold mb-4">{produit?.price}</h3>
        ...
        <div className="d-flex align-items-center mb-4 pt-2">
          <div className="input-group quantity mr-3" style={{width: 130}}>
            <div className="input-group-btn">
              <button onClick={DecrimentQuantity} className="btn btn-primary btn-minus">
                <i className="fa fa-minus" />
              </button>
            </div>
            <input type="text" className="form-control bg-secondary text-center" value={Quantity} />
            <div className="input-group-btn">
              <button onClick={IncrimentQuantity} className="btn btn-primary btn-plus">
                <i className="fa fa-plus" />
              </button>
            </div>
          </div>
          <button onClick={()=>AddCart(produit)} className="btn btn-primary px-3"><i className="fa fa-shopping-cart mr-1" /> Add To Cart</button>
        </div>
